...
const Home = () => {
  ...
  return React.createElement("div", null, React.createElement("header", null, React.createElement("h2", null, "On It")), React.createElement("main", {
    ...
    onClick: e => {
      ...
      _api.API.login(inputEmail.value, inputPass.value);
    }
  }, "Login"))));
};
...
},{"./pages":"src/pages/index.jsx"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
